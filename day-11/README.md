...
each monkey has had one turn. The process of each monkey taking a single turn is
called a **round**.
...
end up inspecting and throwing many items by the time its turn comes around. If
...
on the **two most active monkeys** if you want any hope of getting your stuff
back. Count the **total number of times each monkey inspects items** over 20
rounds:
